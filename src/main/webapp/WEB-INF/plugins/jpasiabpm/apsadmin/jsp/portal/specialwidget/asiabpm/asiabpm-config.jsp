...
<s:form action="saveConfig" namespace="/do/jpasiabpm/Asiabpm/Page/SpecialWidget/jpasiabpmAsiabpmConfig" cssClass="form-horizontal">
		...
		<div class="form-group margin-base-top">
			<div class="col-xs-12">
				...
				<div class="input-group">
					<wpsf:select list="asiabpmsId" name="id" id="id" cssClass="form-control" />
